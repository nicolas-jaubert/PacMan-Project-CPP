...
{
    string BeginLink ="../Pacman-CPP/Nos_fichiers/TxtDirectory/StartSheet";
    bool var = true;
    unsigned y;
    while(var)
    {
...
{
    string BeginLink ="../Pacman-CPP/Nos_fichiers/TxtDirectory/EndSheetsDr/EndSheet";
    bool var = true;
    unsigned y;
...
void Credit()
{
    ...
    {
        ClearScreen();
        ifstream Flow ("../Pacman-CPP/Nos_fichiers/TxtDirectory/credit.txt");
        string line;
